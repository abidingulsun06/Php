...
class DataBase
{
  ...
  //Tekrarlanan error mesajlar için
  ...
  //hacker params saldırısını önlemek için prepara execute yapısı
  ...
  private function ConnectDb()
  {
    ...
    try {
      ...
      //sayfalama işllemleri yapmak için çalıştırırız sayfalama yoksa kapatmak zorundayız
      $this->pdo->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);

      //transcatione aktif ettiğimiz zaman mutlaka rollback ve commit functionlarını php sqllerinin altına yazmamız lazım
  ...
  //transactiona dışardan erişim sağlamak için kullanırız
  public function myCommit()
  {
    $this->pdo->commit();
  }

  //transactioda işlemi geri alacaksak dışardan erişim için bunu sağlarız
  ...
  // {
  //Bağlantıyı Kapat
  //   echo "<div class='alert alert-danger'>Bağlantı sonlandırıldı</div>";
  //   $this->pdo = NULL;
  // }
}//class end  
